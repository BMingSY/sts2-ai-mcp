...
python -m sts2_mcp.network_server --host 0.0.0.0 --port 8765 --transport streamable-http --path /mcp --tool-profile ai_safe_v2 --bearer-token "replace-with-a-long-random-token"
```
